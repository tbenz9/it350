...
require_once("DAO/WarrantyCriteriaDAO.php");

/**
 * The WarrantyCriteria class extends WarrantyDAOCriteria and is used
 ...
 * @version 1.0
 */
class WarrantyCriteria extends WarrantyCriteriaDAO
{
