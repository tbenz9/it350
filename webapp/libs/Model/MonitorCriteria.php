...
require_once("DAO/MonitorCriteriaDAO.php");

/**
 * The MonitorCriteria class extends MonitorDAOCriteria and is used
 ...
 * @version 1.0
 */
class MonitorCriteria extends MonitorCriteriaDAO
{
