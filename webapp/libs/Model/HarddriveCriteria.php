...
require_once("DAO/HarddriveCriteriaDAO.php");

/**
 * The HarddriveCriteria class extends HarddriveDAOCriteria and is used
 ...
 * @version 1.0
 */
class HarddriveCriteria extends HarddriveCriteriaDAO
{
