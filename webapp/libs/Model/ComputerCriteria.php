...
require_once("DAO/ComputerCriteriaDAO.php");

/**
 * The ComputerCriteria class extends ComputerDAOCriteria and is used
 ...
 * @version 1.0
 */
class ComputerCriteria extends ComputerCriteriaDAO
{
