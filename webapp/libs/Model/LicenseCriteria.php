...
require_once("DAO/LicenseCriteriaDAO.php");

/**
 * The LicenseCriteria class extends LicenseDAOCriteria and is used
 ...
 * @version 1.0
 */
class LicenseCriteria extends LicenseCriteriaDAO
{
