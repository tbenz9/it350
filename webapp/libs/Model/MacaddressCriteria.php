...
require_once("DAO/MacaddressCriteriaDAO.php");

/**
 * The MacaddressCriteria class extends MacaddressDAOCriteria and is used
 ...
 * @version 1.0
 */
class MacaddressCriteria extends MacaddressCriteriaDAO
{
