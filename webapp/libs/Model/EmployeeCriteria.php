...
require_once("DAO/EmployeeCriteriaDAO.php");

/**
 * The EmployeeCriteria class extends EmployeeDAOCriteria and is used
 ...
 * @version 1.0
 */
class EmployeeCriteria extends EmployeeCriteriaDAO
{
