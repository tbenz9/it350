...
GlobalConfig::$CONNECTION_SETTING->DBName = "it350";
GlobalConfig::$CONNECTION_SETTING->Username = "root";
GlobalConfig::$CONNECTION_SETTING->Password = "cookies123";
...
/** the root url of the application with trailing slash, for example http://localhost/it350/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'it350/';
